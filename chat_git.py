...
#                                     expander_title = f"Citation {len(st.session_state.citations) + idx} - {file_name}"
#                                     if 'page_number' in metadata:
#                                         page_number = metadata['page_number']
#                                         if file_name.endswith(('.pdf', '.pptx', '.ppt', '.doc', '.docx')):
#                                             expander_title += f" - Page {page_number}"
...
#                                     new_citations.append({"title": expander_title, "content": content})

#                                     with st.expander(expander_title, expanded=False):
#                                         st.write(f"- **Preview:**")
#                                         st.write(content)

#                             st.session_state.citations.extend(new_citations)
